...
- Mirror the visible intake, Tournament of Options, Recommended Plan, judge verdicts, deterministic gate outputs, runtime evidence, and final status into those artifacts as you work. Artifacts are concise evidence, not a transcript dump.

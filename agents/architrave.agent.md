...
First **classify** the request, produce the visible intake block for non-trivial work, and **scale the crew to it** — don't fan out the whole roster for a small change:
